...
$bdd = new PDO('mysql:host=localhost;dbname=ensitdb','root','root');
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="foo">
    ...
    <div class="col-lg-4">
      <div class="propos">
        ...
        <p>Ce site a été conçu dans le cadre du projet d'application de gestion d'une bibliotheque par M. Jean AYIKPA<br><a href="admin/index.php">Administration</a>
      </div>
    </div>
    <div class="col-lg-4">
      <div class="team">        
